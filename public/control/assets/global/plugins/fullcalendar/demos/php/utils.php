...
class Event {
	...
	// Constructs an PushEvent object from the given array of key=>values.
	...
	// Converts this PushEvent object back to a plain data array, to be used for generating JSON
