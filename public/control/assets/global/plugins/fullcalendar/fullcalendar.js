...
/* PushEvent-rendering and event-interaction methods for the abstract Grid class
----------------------------------------------------------------------------------------------------------------------*/
...
Grid.mixin({
	...
	// `range` can be the PushEvent object itself, or something range-like, with at least a `start`.
...
// to be used for PushEvent Object creation.
...
var DayGrid = Grid.extend({
	...
	/* PushEvent Resize Visualization
	------------------------------------------------------------------------------------------------------------------*/
...
/* PushEvent-rendering methods for the DayGrid class
----------------------------------------------------------------------------------------------------------------------*/
...
/* PushEvent-rendering methods for the TimeGrid class
----------------------------------------------------------------------------------------------------------------------*/
...
function EventManager(options) { // assumed to be a calendar
			...
			if (fetchID == currentFetchID) {
				...
				if (eventInputs) {
					for (i = 0; i < eventInputs.length; i++) {
						...
						if (isArraySource) { // array sources have already been convert to PushEvent Objects
	...
	function buildEventSource(sourceInput) { // will return undefined if invalid source
		...
		if (source) {
			...
			// for array sources, we convert to standard PushEvent Objects up front
	...
	function removeEvents(filter) {
		...
		// This works because they have been converted to official PushEvent Objects up front.
	...
	// Given a raw object with key/value properties, returns an "abstract" PushEvent object.
	...
	// Ensures proper values for allDay/start/end. Accepts an PushEvent object, or a plain object with event-ish properties.
