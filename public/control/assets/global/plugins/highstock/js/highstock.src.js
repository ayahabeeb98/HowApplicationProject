...
extend(Highcharts.Pointer.prototype, {
	...
	pinch: function (e) {
		...
		// PushEvent type is touchmove, handle panning and pinching
...
Scroller.prototype = {
	...
	init: function () {
		...
		/**
		 * PushEvent handler for the mouse down event.
		 */
		...
		/**
		 * PushEvent handler for the mouse move event.
		 */
		...
		/**
		 * PushEvent handler for the mouse up event.
		 */
